...
Si estas en la terminal o usas el IDLE de python puedas usar la función `type()`, la cual pasándole un argumento, en este caso el nombre de cualquiera de las variables que hayas declarado, te mostrara el tipo de clase de la variable.
```python
